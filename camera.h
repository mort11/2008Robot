...
#define BLUE_R_MIN_DEFAULT	15//30	// Rmin for call to Track_Color()
#define BLUE_R_MAX_DEFAULT	23//50	// Rmax for call to Track_Color()
#define BLUE_G_MIN_DEFAULT	32//55	// Gmin for call to Track_Color()
#define BLUE_G_MAX_DEFAULT	46//75	// Gmax for call to Track_Color()
#define BLUE_B_MIN_DEFAULT	26//38  // Bmin for call to Track_Color()
#define BLUE_B_MAX_DEFAULT	40//58  // Bmax for call to Track_Color()


#define NF_DEFAULT		10	// value for call to Noise_Filter()

#define AGC_DEFAULT		0	// Automatic Gain Control Register [0/0x00]
#define BLU_DEFAULT		100	// Blue Gain Control Register [128/0x80]
#define RED_DEFAULT		100 // Red Gain Control Register [128/0x80]
#define SAT_DEFAULT		128	// Saturation Control Register [128/0x80]
#define BRT_DEFAULT		128	// Brightness Control Register [128/0x80]
#define AEC_DEFAULT		127	// Automatic Exposure Control Register [127/0x7F]
