...
/*
long Get_vGyro_Angle_Handler (void)
{
	long temp_angle;

	// calculate angle
	temp_angle = (vGyro_base_angle * angle_correction_numerator) / angle_correction_denominator;
...
long Get_vGyro1_Angle(void)
{
    return Get_vGyro_Angle_Handler() - vGyro1_angle;
}

long Get_vGyro2_Angle(void)
{
    return Get_vGyro_Angle_Handler() - vGyro2_Angle;
}
*/
/*******************************************************************************
*
