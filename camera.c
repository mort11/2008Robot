	...
	else
	{
		...
		switch(state)
		{
			...
			case STATE_SEVENTEEN:
				...
				if (Get_Auto_Mode() > 2)    // second half of the switch is blue
                {
                    Track_Color(BLUE_R_MIN_DEFAULT, BLUE_R_MAX_DEFAULT,
							BLUE_G_MIN_DEFAULT, BLUE_G_MAX_DEFAULT,
							BLUE_B_MIN_DEFAULT, BLUE_B_MAX_DEFAULT);
                }
